...
- **Inference Time (batch)**: `94.3 ms`
- **Total Pipeline Execution**: `325.20s`
...
|---|---|---|---|---|
| LightGBM | 0.8945 | 0.8730 | 0.8942 | 4.46s |
| XGBoost | 0.8741 | 0.8562 | 0.8737 | 4.70s |
| RandomForest | 0.8528 | 0.8440 | 0.8519 | 2.50s |
| ExtraTrees | 0.8351 | 0.8308 | 0.8342 | 0.77s |
